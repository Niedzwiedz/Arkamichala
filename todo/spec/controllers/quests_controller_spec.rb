...
RSpec.describe QuestsController, :type => :controller do
  ...
  let(:valid_attributes) {
      {nazwa: "TestQuestI", difficulty: 3, deadline:' 2016-12-04 00:00:00', description: "Opis", created_at: '2013-12-04 00:00:00'}
  }

  let(:invalid_attributes) {
      {nazwa: "333", deadline: "2016-12-24  00:00:00", description: "Opis", created_at: "2015-12-24 00:00:00"}
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
      {nazwa: "TestQuestII", difficulty: 2, deadline: "2016-12-04 00:00:00", description: "Opis", created_at: "2013-12-04 00:00:00"}
      }
